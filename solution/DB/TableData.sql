...
VALUES (2, 1, 18, 18, 16, 'Moms Winter Clothes', '1', 2, NOW(), NOW(), 'At Source', 'parents bedroom', 'leggings, sweatshirts'),
              ...
              (2, 48, 18, 18, 24, 'Board games', '1', 2, NOW(), NOW(), 'At Source', 'living room', 'monopoly, clue, scrabble'),
              (2, 49, 16, 12, 12, 'Books', '2', 3, NOW(), NOW(), 'At Source', 'living room', 'Harry Potter, Fahrenheit 451'),
              (2, 50, 16, 12, 12, 'More Books', '2', 3, NOW(), NOW(), 'At Source', 'living room', 'Tom Jones, Pride and Prejudice, Mrs Dalloway'),
              (2, 51, 16, 12, 12, 'More Books', '2', 3, NOW(), NOW(), 'At Source', 'living room', 'Great Expectations, Jane Eyre, Bleak House'),
              (2, 52, 16, 12, 12, 'More Books', '2', 3, NOW(), NOW(), 'At Source', 'living room', 'Wuthering Heights, Oryx and Crake, Atonement'),
              (2, 53, 16, 12, 12, 'More Books', '2', 3, NOW(), NOW(), 'At Source', 'living room', 'MaddAddam, The Year of the Flood, Nineteen Eighty-four'),
              (2, 54, 36, 36, 4, 'Dog bed', '1', 2, NOW(), NOW(), 'At Source', 'living room', 'dog bed'),
              (2, 55, 16, 12, 12, 'Dog bowls', '1', 2, NOW(), NOW(), 'At Source', 'living room', 'water bowl, food bowl'),
              (2, 56, 24, 18, 24, 'Dog food', '1', 4, NOW(), NOW(), 'At Source', 'living room', 'dog food'),
              (2, 57, 18, 18, 24, 'Dog toys', '1', 2, NOW(), NOW(), 'At Source', 'living room', 'ducky, leash, Gumby'),

              (2, 58, 16, 12, 12, 'Toiletries', '2', 2, NOW(), NOW(), 'At Source', 'parents bathroom', 'toilet paper, soap, shampoo, toothpaste'),
              (2, 59, 16, 12, 12, 'Toiletries', '2', 2, NOW(), NOW(), 'At Source', 'Sallys bathroom', 'toilet paper, soap, shampoo, toothpaste'),
              (2, 60, 16, 12, 12, 'Toiletries', '2', 2, NOW(), NOW(), 'At Source', 'bathroom', 'toilet paper, soap, bandaids, advil'),
              (2, 61, 16, 12, 12, 'Cleaning Supplies', '4', 2, NOW(), NOW(), 'At Source', 'utility room', 'bleach, windex, trash bags'),
              (2, 62, 16, 12, 12, 'Laundry Supplies', '3', 2, NOW(), NOW(), 'At Source', 'utility room', 'detergent, drier sheets'),
              ...
              (2, 65, 24, 18, 24, 'Printer', '4', 2, NOW(), NOW(), 'At Source', 'miscellaneous', 'printer, ink'),

              (2, 66, 16, 12, 12, 'Tools', '1', 3, NOW(), NOW(), 'At Source', 'garage', 'ratchets, nails, bolts, nuts'),
              (2, 67, 16, 12, 12, 'Tools', '1', 3, NOW(), NOW(), 'At Source', 'garage', 'wrenches, screws, drill bits, hammer'),
              (2, 68, 16, 12, 12, 'Tools', '1', 3, NOW(), NOW(), 'At Source', 'garage', 'drill, spade, shears'),

              (2, 69, 18, 18, 24, 'Holiday Decorations', '2', 3, NOW(), NOW(), 'At Source', 'miscellaneous', 'Christmas decorations'),
              (2, 70, 18, 18, 24, 'Holiday Decorations', '2', 3, NOW(), NOW(), 'At Source', 'miscellaneous', 'Halloween decorations'),
              (2, 71, 18, 18, 24, 'Odds and ends', '1', 2, NOW(), NOW(), 'At Source', 'miscellaneous', 'towels, slippers, nerf ball');
